...
namespace Domovoy_DataAccess.Migrations
{
    ...
    [Migration("20220813113454_pushOrderHeaderAndDetailToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domovoy_Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domovoy_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domovoy_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domovoy_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domovoy_Models.InquiryDetail", b =>
                {
                    b.HasOne("Domovoy_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domovoy_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Domovoy_Models.InquiryHeader", b =>
                {
                    b.HasOne("Domovoy_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Domovoy_Models.OrderDetail", b =>
                {
                    b.HasOne("Domovoy_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Domovoy_Models.OrderHeader", b =>
                {
                    b.HasOne("Domovoy_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
